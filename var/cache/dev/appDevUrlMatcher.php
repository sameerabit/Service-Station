    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/customer')) {
            ...
            if (rtrim($pathinfo, '/') === '/customer') {
                ...
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'customer_index');
                }
            ...
            if ($pathinfo === '/customer/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\CustomerController::newAction',  '_route' => 'customer_new',);
            }
            not_customer_new:
            ...
            if (preg_match('#^/customer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'customer_show')), array (  '_controller' => 'AppBundle\\Controller\\CustomerController::showAction',));
            }
            not_customer_show:
            ...
            if (preg_match('#^/customer/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'customer_edit')), array (  '_controller' => 'AppBundle\\Controller\\CustomerController::editAction',));
            }
            not_customer_edit:
